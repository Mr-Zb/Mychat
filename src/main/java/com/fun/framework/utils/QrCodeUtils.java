...
public class QrCodeUtils {
    ...
    public static void encode(String content, String logoPath, OutputStream output, boolean needCompress)
        ...
        ImageIO.write(image, FORMAT, new File("/Users/mac/Desktop/img/erweima.jpg"));
        ImageIO.write(image, FORMAT, output);
    }

    public static InputStream encode3(String content, String logoPath, boolean needCompress)
            throws Exception {
        BufferedImage image = QrCodeUtils.createImage(content, logoPath, needCompress);
        return bufferedImageToInputStream(image);
    }

    public static void encode(String content, String logoPath,  boolean needCompress,String name)
            throws Exception {

        BufferedImage image = QrCodeUtils.createImage(content, logoPath, needCompress);
        ImageIO.write(image, FORMAT, new File(logoPath + name + ".jpg"));
    }
