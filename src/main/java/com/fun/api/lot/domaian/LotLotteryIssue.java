package com.fun.api.lot.domaian;
...
@ApiModel
public class LotLotteryIssue implements Serializable {
    ...
    public String toString() {
        return "LotLotteryIssue [pkId=" + pkId + ", createUser=" + createUser + ", createTime=" + createTime
                + ", updateUser=" + updateUser + ", updateTime=" + updateTime + ", dataVersion=" + dataVersion
                + ", productId=" + productId + ", lotteryIssue=" + lotteryIssue + ", bgnTime=" + bgnTime + ", endTime="
                + endTime + ", openTime=" + openTime + ", openFlag=" + openFlag + ", openCode=" + openCode
                + ", openCodeScource=" + openCodeScource + ", openFeature1=" + openFeature1 + ", openFeature2="
                + openFeature2 + ", openFeature3=" + openFeature3 + ", openFeature4=" + openFeature4 + ", openFeature5="
                + openFeature5 + ", amount1=" + amount1 + ", amount2=" + amount2 + ", amount3=" + amount3 + ", amount4="
                + amount4 + "]";
    }
